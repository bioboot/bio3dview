...
To install the development version of bio3dview from [GitHub](https://github.com/bioboot/bio3dview), use:
...
Dependencies include the R CRAN packages [bio3d](https://cran.r-project.org/web/packages/bio3d/index.html) and [NGLVieweR](https://cran.r-project.org/web/packages/NGLVieweR/), which can be installed with:
...
Many additional visualization options are available. Check out the [Getting Started vignette](https://bioboot.github.io/bio3dview/articles/bio3dview.html) for more examples, or refer to individual function [help pages](https://bioboot.github.io/bio3dview/reference/index.html) for detailed documentation.
